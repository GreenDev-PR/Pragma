...
exports.goesVariables = [
  ...
  {'variableName':'reference_ET_PenmanMonteith','description':'Daily reference evapotranspiration (mm/day) using the Penman-Monteith method.'},
  {'variableName':'reference_ET_HargreavesSamani','description':'Daily reference evapotranspiration (mm/day) using the Hargreaves-Samani method.'},
  {'variableName':'reference_ET_PriestlyTaylor','description':'Daily reference evapotranspiration (mm/day) using the Priestly-Taylor method.'},
